...
- `index.html` — the project page (teaser, abstract, method, video results, tables, BibTeX)
- `static/images/` — paper figures exported from PDF (teaser, pipeline, atomic movements, open-ended results)
- `static/videos/comparison/` — per-scene baseline comparisons (CinemaTraj vs. ChatCam+GenDoP vs. CCTG)
- `static/videos/ablation/` — per-scene ablation variants (w/o Anchor Selector, w/o Parametric Traj., w/o SDF-based Opt.)
- `static/posters/` — first-frame poster images for the video players
